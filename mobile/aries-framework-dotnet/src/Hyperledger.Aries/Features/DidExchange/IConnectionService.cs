...
namespace Hyperledger.Aries.Features.DidExchange
{
    ...
    public interface IConnectionService
    {
        ...
        /// <summary>
        /// Creates a invitation asynchronous.
        /// </summary>
        /// <param name="agentContext">Agent Context.</param>
        /// <param name="config">An optional configuration object used to configure the resulting invitations presentation</param>
        /// <returns>The async.</returns>
        Task<(ConnectionInvitationMessage, ConnectionRecord)> CreateBleInvitationAsync(IAgentContext agentContext, 
        ...
        /// <summary>
        /// Creates a BLE Request async.
        /// </summary>
        /// <param name="agentContext">Agent Context.</param>
        /// <param name="offer">Offer.</param>
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.A2AMessageTransmissionError.</exception>
        /// <returns>Connection identifier unique for this connection.</returns>
        Task<(ConnectionRequestMessage, ConnectionRecord)> CreateBleRequestAsync(IAgentContext agentContext, ConnectionInvitationMessage offer,
            string bleEndpoint);
        ...
        /// <summary>
        /// Accepts a ble connection request and sends a ble connection response
        /// </summary>
        /// <param name="agentContext">Agent Context.</param>
        /// <param name="connectionId">Connection identifier.</param>
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.A2AMessageTransmissionError</exception>
        ...
        /// <exception cref="AriesFrameworkException">Throws with ErrorCode.RecordInInvalidState.</exception>
        /// <returns>The response async.</returns>
        Task<(ConnectionResponseMessage, ConnectionRecord)> CreateBleResponseAsync(IAgentContext agentContext, string connectionId, string endpoint);
